...
public class Player extends DamageableEntity {
    ...
    public void loadTexture() {
        Gdx.app.postRunnable(() -> {
            t = new TextureRegion(new Texture(Gdx.files.internal(PLAYER_PATH + colour.toString() + PLAYER_STANDING)));
            frames = new TextureRegion[4][2];

            frames[0][0] = new TextureRegion(new Texture(Gdx.files.internal(PLAYER_PATH + colour.toString() + PLAYER_WALKING_1)));
            frames[0][0].flip(true, false);
            frames[0][1] = new TextureRegion(new Texture(Gdx.files.internal(PLAYER_PATH + colour.toString() + PLAYER_WALKING_2)));
            frames[0][1].flip(true, false);

            frames[1][0] = new TextureRegion(new Texture(Gdx.files.internal(PLAYER_PATH + colour.toString() + PLAYER_WALKING_1)));
            frames[1][1] = new TextureRegion(new Texture(Gdx.files.internal(PLAYER_PATH + colour.toString() + PLAYER_WALKING_2)));

            frames[2][0] = new TextureRegion(new Texture(Gdx.files.internal(PLAYER_PATH + colour.toString() + PLAYER_UP_1)));
            frames[2][1] = new TextureRegion(new Texture(Gdx.files.internal(PLAYER_PATH + colour.toString() + PLAYER_UP_2)));

            frames[3][0] = new TextureRegion(new Texture(Gdx.files.internal(PLAYER_PATH + colour.toString() + PLAYER_DOWN)));
            frames[3][1] = new TextureRegion(new Texture(Gdx.files.internal(PLAYER_PATH + colour.toString() + PLAYER_STANDING)));

...
/**
 * Spider enemy, appears throughout the game
 */
public class Spider extends Enemy {
    ...
    public void loadAnim() {
        ...
        frames[0] = new TextureRegion(Assets.getTex(("graphics/entity/enemy/spider_walk1.png")));
        frames[1] = new TextureRegion(Assets.getTex(("graphics/entity/enemy/spider_walk2.png")));
